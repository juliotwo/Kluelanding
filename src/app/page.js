      ...
      <div className='h-screen w-full bg-hero bg-cover bg-center'>
        <div className='flex flex-col h-full w-full bg-[#533ef533]'>
          ...
          <Container className='flex-1 justify-center pb-20 flex flex-col tracking-wide'>
            <h1 className='text-4xl sm:text-5xl font-bold font-rocGrotesk text-white'>{mainLandingData.hero.title}</h1>
            <p className='text-white mt-4 mb-5 text-sm sm:text-base'>{mainLandingData.hero.description}</p>
            <Link href={mainLandingData.hero.button.href}>
              <Button flatWhite className='text-xs lg:text-base'>{mainLandingData.hero.button.title}</Button>
            </Link>
          </Container>
        </div>
      </div>
      ...
      <div className='flex flex-col bg-gradientLanding'>
        <Container className='flex flex-col-reverse lg:grid lg:grid-cols-2 py-24 items-center justify-center gap-40 lg:gap-0'>
          ...
          <div className='flex flex-col max-w-[600px]'>
            <h2 className='text-3xl sm:text-5xl font-rocGrotesk'>{mainLandingData.aboutUs.title}</h2>
            <SpecialText className='font-light mt-4 text-sm sm:text-base'>
              {mainLandingData.aboutUs.description}
            </SpecialText>

            <div className='mt-10'>
              <Button special>
                {mainLandingData.aboutUs.button.title}
              </Button>
            </div>
          </div>
        </Container>
        ...
        <Container className='flex flex-col justify-center items-center py-24'>
          <h1 className='text-4xl sm:text-5xl font-rocGrotesk'>{mainLandingData.join.title}</h1>
          <p className='text-secondary mt-5 font-light text-sm sm:text-base'>{mainLandingData.join.description}</p>
        </Container>

        <Container className='flex flex-col justify-center items-center py-24'>
          <h2 className='text-3xl sm:text-4xl  font-bold font-rocGrotesk'>{mainLandingData.benefits.title}</h2>
          <div className='text-sm font-medium flex flex-col mt-10 gap-4'>
            {map(mainLandingData.benefits.features, (item, i) => (
              <div className='flex items-center gap-2 text-center justify-center' key={i}>
